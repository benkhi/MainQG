...
def main():
    ...
    metric = evaluate.load("race" if args.version_2_with_negative else "race")
    ...
    if args.with_tracking:
        log = {
            "race" if args.version_2_with_negative else "race": eval_metric,
            "train_loss": total_loss,
            "epoch": epoch,
            "step": completed_steps,
        }
        if args.do_predict:
            log["race_predict" if args.version_2_with_negative else "race_predict"] = predict_metric
